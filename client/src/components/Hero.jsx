...
const Hero = () => {
  return (
    <div className='flex relative flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.jpg")] bg-no-repeat bg-cover bg-center h-screen -z-2'>
      ...
      <h1 className="font-playfair text-2xl md:text-5xl md:leading-5xl font-bold md:font-extrabold max-w-xl mt-4">
        Discover Your Perfect Gateway Destination
      </h1>
      <p className="max-w-130 mt-2 text-sm md:text-base">
        Unparalleled luxury and comfort await at the world's most exclisive
      ...
      <form className="bg-white backdrop-blur-xl text-black rounded-lg px-6 py-4  flex flex-col mt-6 md:flex-row max-md:items-start gap-4 max-md:mx-auto">
        ...
        <button className="flex items-center justify-center gap-1 rounded-md bg-black pt-[3px] pb-[5px] px-4 text-white mt-auto cursor-pointer max-md:w-full max-md:py-1">
