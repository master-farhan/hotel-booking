...
const ExclusiveOffers = () => {
  return (
    <div className="flex flex-col items-center pt-20 pb-30 px-6 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col md:flex-row items-center justify-between w-full">
        ...
        />
        <button className="group flex items-center gap-2 font-medium cursor-pointer max-mt-12">
          View All Offers
          <img
